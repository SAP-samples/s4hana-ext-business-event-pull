sap.ui.define([
		...
		return BaseObject.extend("behsample.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias behsample.model.ListSelector
			 */
			 ...
			 * @return {behsample.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
