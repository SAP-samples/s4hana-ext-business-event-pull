sap.ui.define([
		...
		opaTest("MasterList Filtering on BusEventPriority less than 100", function(Given, When, Then) {

			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog("<BusEventPriority>").
		...
		opaTest("MasterList Filtering on BusEventPriority more than 100", function(Given, When, Then) {
			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog(">100 <>").
				and.iPressOKInViewSelectionDialog();
