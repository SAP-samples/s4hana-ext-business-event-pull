sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("behsample/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("behsample.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["behsample/localService/mockserver"], function (mockserver) {
